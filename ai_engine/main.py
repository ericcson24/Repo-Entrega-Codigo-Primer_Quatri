...
# Servicio principal del motor de estimación. Inicializa la API y registra las rutas.
app = FastAPI(title="Motor de Estimación Renovable", version="1.0")
...
@app.get("/")
def read_root():
    return {"mensaje": "Servicio de datos y motor operativo"}
